...
Designed for a **Hammond 1456KH3BKBU** sloped aluminum console (254 × 211 × 76 mm, 15° slope): 10.1″ touchscreen in the top panel, jumbo arcade buttons (STOP / VOL+ / VOL− / NEXT) along the operator edge wired to GPIO, Pi 4 + USB DAC or BT speaker inside. Artist rendering (generated by `tools/render-enclosure.py`):

![BatterBox enclosure rendering](docs/enclosure/batterbox-enclosure-render.png)
